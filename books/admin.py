...
from .models import Book, Category, BookCategory, BookFile, Language, Review, Comment, UserBookmark, UserBook
...
class BookAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        try:
            book_file_instance = BookFile.objects.get(book=obj.id)
        except:
            book_file_instance = BookFile.objects.create(book=obj)
...
class CommentAdmin(admin.ModelAdmin):
    list_display = ('user', 'book_name', 'description', 'created_date', 'is_delete')
...
class UserBookmarkAdmin(admin.ModelAdmin):
    list_display = ('book_title', 'user_username', 'added_time', 'is_delete')
    list_filter = ('added_time', 'is_delete')
