...
class UserAdmin(admin.ModelAdmin):
    list_display = ('id', 'username', 'email', 'is_active', 'is_publisher', 'date_joined', 'publications_image_preview')
    fieldsets = (
    ...
    readonly_fields = ('identity_image_preview', 'publications_image_preview', 'date_joined')
...
class UserActivityCodeAdmin(admin.ModelAdmin):
    ...
    created_date_time.admin_order_field = 'created_date'
    created_date_time.short_description = 'Created Date Time'

    def expire_date_time(self, obj):
        return obj.expire_date_time
    expire_date_time.admin_order_field = 'validity_duration'
    expire_date_time.short_description = 'Validity Duration Time'
