...
(5, 'نبرد من', 'آدولف هیتلر' , 'مهدی اکبر پور', 1395, 'http://localhost:8080/book-covers/demo-6.jpg' ,30000, 663, 1, FALSE, 'کتاب نبرد من تنها کتابی است که انتشار آن در آلمان ممنوع است. آدولف هیتلر در این کتاب دیدگاه‌های خود را بیان کرده، اثری که مبنای برپایی حزب ناسیونالیسم (نازی) شد و جهان را درگیر مصیبتی همه‌گیر کرد.'),
...
(6, 'کمال گرای مضطرب', 'مایکل پی توهیگ', 'شقایق مختاری', 1400, 'http://localhost:8080/book-covers/demo-11.jpg', 25000, 312, 1, FALSE, 'عشق و خودشناسی در تقابل با یکدیگر! رافائل ژیوردانو خالق کتاب محبوب «زندگی دومت زمانی آغاز می‌شود که می‌فهمی فقط یک زندگی داری» این‌بار به سراغ موضوع تازه‌ای رفته است. داستان کتاب فرشته عشق بال‌های مقوایی دارد روایتی ماجراجویانه و هیجان‌انگیز درباره عشق و تلاش برای یافتن آن در زندگی و در میان روابط انسانی است.'),
(6, 'قدرت سکوت: قدرت درونگراها', 'سوزان کین', NULL, 1401, 'http://localhost:8080/book-covers/demo-12.jpg', 19900, 274, 1, FALSE, 'کتاب در حسرت فرشته به قلم زهره زندیه، داستانی اجتماعی و جذاب و متعهد به ارزش‌‌‌های انسانی به شمار می‌رود که شما را با خود و احساسات بی‌آلایشتان آشتی می‌دهد. این کتاب روایتگر دردها و مشکلات بسیاری از افراد جامعه است که لحظات غیر قابل وصفی را برای شما رقم می‌زند.'),
...
(6, 'در حسرت فرشته', 'زهره زندیه', NULL, 1401, 'http://localhost:8080/book-covers/demo-16.jpg', 19900, 274, 1, FALSE, 'کتاب در حسرت فرشته به قلم زهره زندیه، داستانی اجتماعی و جذاب و متعهد به ارزش‌ ‌های انسانی به شمار می‌رود که شما را با خود و احساسات بی‌آلایشتان آشتی می‌دهد. این کتاب روایتگر دردها و مشکلات بسیاری از افراد جامعه است که لحظات غیر قابل وصفی را برای شما رقم می‌زند.');
...
VALUES
(16, 2, '2023-01-16 09:00:00', FALSE),
